...
const I18N = (() => {
  const D = {
    ...
    e_envioParcial: ['✈️ Envío parcial en camino', '✈️ Partially shipped'],
    e_enviadoTodo:  ['✈️ Todo enviado — falta el balance invoice', '✈️ All shipped — upload the balance invoice'],
    e_final:        ['⚖️ Cotización final — por pagar balance', '⚖️ Final quote sent — awaiting balance'],
    e_pagoFinal:    ['💵 Saldado — esperando entregas', '💵 Balance received'],
    ...
    ev_envioParcial:['✈️ Envío en camino con su tracking', 'Shipment created'],
    ev_envioCompleto:['✈️ ÚLTIMO envío en camino — el lote va completo', 'All pieces shipped 🎉'],
    ev_envioRecibido:['📦 Marcaste un envío como recibido', '📦 José received a shipment'],
    env_titulo:     ['✈️ Envíos', '✈️ Shipments'],
    env_nuevo:      ['—', '✈️ New shipment — pick the pieces + tracking'],
    env_sinEnviar:  ['Sin enviar todavía:', 'Not shipped yet:'],
