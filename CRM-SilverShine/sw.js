...
const ARCHIVOS = [
  ...
  './js/jspdf.min.js',
  './js/pdf.js?v=145',
  './js/reportes.js?v=145',
  './js/db.js?v=145',
  './js/sync.js?v=145',
  './js/ui.js?v=145',
  './js/clientes.js?v=145',
  './js/catalogo.js?v=145',
  './js/calculadora.js?v=145',
  './js/facturas.js?v=145',
  './js/cotizaciones.js?v=145',
  './js/confecciones.js?v=145',
  './js/taller-rd.js?v=145',
  './js/cobros.js?v=145',
  './js/finanzas.js?v=145',
  './js/caja.js?v=145',
  './js/inventario.js?v=145',
  './js/tareas.js?v=145',
  './js/leads.js?v=145',
  './js/app.js?v=145',
  './manifest.json',
