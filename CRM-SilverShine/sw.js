...
const ARCHIVOS = [
  ...
  './js/jspdf.min.js',
  './js/pdf.js?v=136',
  './js/reportes.js?v=136',
  './js/db.js?v=136',
  './js/sync.js?v=136',
  './js/ui.js?v=136',
  './js/clientes.js?v=136',
  './js/catalogo.js?v=136',
  './js/calculadora.js?v=136',
  './js/facturas.js?v=136',
  './js/cotizaciones.js?v=136',
  './js/confecciones.js?v=136',
  './js/cobros.js?v=136',
  './js/finanzas.js?v=136',
  './js/caja.js?v=136',
  './js/inventario.js?v=136',
  './js/tareas.js?v=136',
  './js/leads.js?v=136',
  './js/app.js?v=136',
  './manifest.json',
