...
const ARCHIVOS = [
  ...
  './js/jspdf.min.js',
  './js/pdf.js?v=144',
  './js/reportes.js?v=144',
  './js/db.js?v=144',
  './js/sync.js?v=144',
  './js/ui.js?v=144',
  './js/clientes.js?v=144',
  './js/catalogo.js?v=144',
  './js/calculadora.js?v=144',
  './js/facturas.js?v=144',
  './js/cotizaciones.js?v=144',
  './js/confecciones.js?v=144',
  './js/taller-rd.js?v=144',
  './js/cobros.js?v=144',
  './js/finanzas.js?v=144',
  './js/caja.js?v=144',
  './js/inventario.js?v=144',
  './js/tareas.js?v=144',
  './js/leads.js?v=144',
  './js/app.js?v=144',
  './manifest.json',
